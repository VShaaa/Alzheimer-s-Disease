...
IMG_WIDTH = 224
EPOCHS = 10
TRAINING_DIR = Path('D:/ML/DS2025/AlzhimerDisease/AlzhimerDisease/dataset/train')
TEST_DIR = Path('D:/ML/DS2025/AlzhimerDisease/AlzhimerDisease/dataset/test')
...
first_batch = next(test_generator)
first_batch_images = first_batch[0]
first_batch_labels = first_batch[1]
fig, axs = plt.subplots(nrows=2, ncols=5, figsize=(20, 8)) # define your figure and axes
